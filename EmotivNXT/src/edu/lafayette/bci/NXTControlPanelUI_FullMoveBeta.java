 ...
 *
 */
public class NXTControlPanelUI_FullMoveBeta implements WindowListener {
	 ...
	 */
	public NXTControlPanelUI_FullMoveBeta() {
		// Create the window
	...
	public void setDirection(int direction) {
		...
		switch(direction) {
			...
			case FORWARD | LEFT:
				image.setIcon(new ImageIcon(this.getClass().getResource("resources/NXT_FL.png"))); break;
			case FORWARD | RIGHT:
				image.setIcon(new ImageIcon(this.getClass().getResource("resources/NXT_FR.png"))); break;
			case BACKWARD | LEFT:
				image.setIcon(new ImageIcon(this.getClass().getResource("resources/NXT_BL.png"))); break;
			case BACKWARD | RIGHT:
				image.setIcon(new ImageIcon(this.getClass().getResource("resources/NXT_BR.png"))); break;
